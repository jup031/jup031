...
var inputNumberRolls= prompt ("How many times do you want to play");
numRolls= parseInt (inputNumberRolls);
numberPlays();
if (isNaN(numRolls) || inputNumberRolls<= 0){
...
function whoWon() {
    ...
    document.querySelector("h4").innerHTML = " $ " + balance;
...
/*
  This repeats the number of plays based on user input.
  The alert is there to keep track of how many rounds went by
*/
function numberPlays(){
